...
namespace bamboosdk
{
    ...
    public abstract class BamBooSdkListener : MonoBehaviour
    {
        ...
        public abstract void onNotificationToken(string fcmToken);

        public abstract void onLocalNotificationClickSuccess(string notifyData);

        public abstract void acceptAgreement(bool isAccept);
        //callback end
        ...
        public void acceptAgreement(string str)
        {
            if (str != null)
            {
                acceptAgreement("true".Equals(str));
                return;
            }
